...
(context: Context) : Classifier {
    ...
    init {
        ...
        intValues = IntArray(Helper.IMAGE_SIZE * Helper.IMAGE_SIZE)
        floatValues = FloatArray(Helper.IMAGE_SIZE * Helper.IMAGE_SIZE * 3)
        outputs = FloatArray(Helper.NUM_CLASSES)
    }

    /**
     * Clean up the resources used by the classifier.
     */
    override fun destroyClassifier() {
     ...
     * and power consuming.
     */
    override fun doRecognize(image: Bitmap): List<Classifier.Recognition> {
        val pixels = Helper.getPixels(image, intValues, floatValues)
